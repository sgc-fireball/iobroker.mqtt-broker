...
class MqttServer {
    ...
    _onConnect(client, packet) {
        ...
        console.log('_onConnect: '+client._id+' / '+client._username);
    ...
    _onPublish(client, packet) {
        console.log('_onSubscribe: '+client._id+' / '+client._username+' : '+JSON.stringify(packet.topic));
        client._lastSeen = Date.now();
    ...
    async _onSubscribe(client, packet) {
        console.log('_onSubscribe: '+client._id+' / '+client._username);
        client._lastSeen = Date.now();
        let granted = [];
        ...
        console.log('_onSubscribe: '+client._id+' / '+client._username+' : '+JSON.stringify(granted));
